...
#print("ClassifyUsing2DCurvHDR: Got this far #1")
#print(class(inputData))
#print(dim(inputData))
#print(sprintf("ClassifyUsing2DCurvHDR: nCols = %d",nCols))
    ##------------------------------------------------------
    ## Normalize variance of data columns.

#print("ClassifyUsing2DCurvHDR: Got this far #2")
...
#print("ClassifyUsing2DCurvHDR: Got this far #3")
...
#print("ClassifyUsing2DCurvHDR: Got this far #4")
...
##
## hdrLevel is the curvHDR parameter controlling the inclusiveness
## of clusters.
##
...
processFlowCAPDataSet <- function(inputFolder, outputFolder, hdrLevel=0.1,
    nmfMethod="snmf/l", numRuns=1, nmfSeed=123456, showScatterPlots=FALSE) {
...
#print(fileList[i])
#makeEmptyFile(outputFolder,sprintf("%03d.read1.try",i),noProgressFiles)
        flowCytData = read.csv(fileList[i])
#makeEmptyFile(outputFolder,sprintf("%03d.read1.done",i),noProgressFiles)
#print(class(flowCytData))
#print(dim(flowCytData))
#        dataDim     = dim(flowCytData)
#        nCols       = dataDim[2]
        nCols       = ncol(flowCytData)
#print(sprintf("processFlowCAPDataSet: nCols = %d",nCols))
...
makeEmptyFile(outputFolder,sprintf("%03d.read2.try",i),noProgressFiles)
...
#makeEmptyFile(outputFolder,sprintf("%03d.ClassifyUsing2DCurvHDR.try",i),noProgressFiles)
#print(class(flowCytData))
#print(dim(flowCytData))
...
#makeEmptyFile(outputFolder,sprintf("%03d.finalWrite.try",i),noProgressFiles)
            write.csv(hardClass,row.names=FALSE,file=hardClassFilePath)
#makeEmptyFile(outputFolder,sprintf("%03d.finalWrite.done",i),noProgressFiles)
...
library(geneplotter,lib.loc="/home/jmm97/lib/lib64/R")
library(NMF,lib.loc="/home/jmm97/lib/lib64/R")
library(RColorBrewer,lib.loc="/home/jmm97/lib/lib64/R")

library(mvtnorm,lib.loc="/home/jmm97/lib/lib64/R")
library(ks,lib.loc="/home/jmm97/lib/lib64/R")
library(rpanel,lib.loc="/home/jmm97/lib/lib64/R")
library(akima,lib.loc="/home/jmm97/lib/lib64/R")
library(locfit,lib.loc="/home/jmm97/lib/lib64/R")
library(ash,lib.loc="/home/jmm97/lib/lib64/R")
library(hdrcde,lib.loc="/home/jmm97/lib/lib64/R")
library(geometry,lib.loc="/home/jmm97/lib/lib64/R")
library(feature,lib.loc="/home/jmm97/lib/lib64/R")
library(robustbase,lib.loc="/home/jmm97/lib/lib64/R")
library(pcaPP,lib.loc="/home/jmm97/lib/lib64/R")
library(rrcov,lib.loc="/home/jmm97/lib/lib64/R")
library(flowCore,lib.loc="/home/jmm97/lib/lib64/R")

library(curvHDR,lib.loc="/home/jmm97/lib/lib64/R")
...
#     nmfMethod = "snmf/l", numRuns = 1, nmfSeed = 123456,
